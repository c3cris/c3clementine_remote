...
class Player(object):
  ...
  def draw(self, surf):
    ...
    if self.track is not None:
      ...
      # self.pg.draw.rect(surf, pg.Color("red"), self.next, 3)
      # self.pg.draw.rect(surf, pg.Color("red"), self.prev, 3)
      # self.pg.draw.rect(surf, pg.Color("red"), self.pause_play, 3)
  ...
  def draw_playlists(self, surf):
    ...
    for playlist in self.playlists:
      ...
      surf.blit(*self.control.draw_text(unicode(self.playlists[playlist]["name"]) + 
        "  [" + unicode(self.playlists[playlist]["item_count"]) + "]", 15, y, 20, color))
      y += 22
